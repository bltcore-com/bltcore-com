      ...
      <span>
         <Stack direction="row" spacing={0}>
            ...
            <IconButton
               title={ls.header.gh}
               aria-label="github"
               onClick={() => window.open(ls.header.gh)}
               sx={iconStyle}
            >
               <GitHubIcon />
            </IconButton>
            ...
            <IconButton
               title={ls.header.li}
               aria-label="linkedin"
               onClick={() => window.open(ls.header.li)}
               sx={iconStyle}
            >
               <LinkedInIcon />
            </IconButton>
            ...
            <IconButton
               title={ls.header.ba}
               aria-label="stock"
               onClick={() => window.open(ls.header.ba)}
               sx={iconStyle}
            >
               <AccountBalanceIcon />
            </IconButton>
            ...
            <IconButton
               title={ls.header.sm}
               aria-label="stock"
               onClick={() => window.open(ls.header.sm)}
               sx={iconStyle}
            >
               <AttachMoneyIcon />
            </IconButton>
            ...
            <IconButton
               title={ls.header.ai}
               aria-label="genai"
               onClick={() => { window.open(ls.header.ai) }}
               sx={iconStyle}
            >
               <SvgIcon sx={iconStyle}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24px" height="24px" aria-hidden="true" role="img">
                     <path
                        fill="currentColor"
            ...
            {/* <IconButton title={u_search} aria-label="search" onClick={() => { navigate(u_search) }} sx={iconStyle}><SearchIcon /></IconButton> */}
            {/* <IconButton title={u_settings} aria-label="settings" onClick={() => {navigate(u_login)}} ><LoginIcon /></IconButton> */}

            <IconButton
               title={u_pwdgen}
               aria-label="password"
               onClick={() => {
                  navigate(location.pathname === u_pwdgen ? "/" : u_pwdgen)
               }}
               sx={iconStyle}
            >
               <LockIcon />
